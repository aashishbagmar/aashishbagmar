...
<table>
  <tr>
    <td width="50%" valign="top">
      <h4><a href="https://github.com/aashishbagmar/CareCaller-AI" style="color: #00e5a0; text-decoration: none;">CareCaller-AI</a></h4>
    ...
    <td width="50%" valign="top">
      <h4><a href="https://github.com/aashishbagmar/express-analytics-rag-assistant" style="color: #00e5a0; text-decoration: none;">Express Analytics RAG</a></h4>
  ...
  <tr>
    <td width="50%" valign="top">
      <h4><a href="https://github.com/aashishbagmar/Holo-For-Windows" style="color: #00e5a0; text-decoration: none;">Holo-For-Windows</a></h4>
    ...
    <td width="50%" valign="top">
      <h4><a href="https://github.com/aashishbagmar/DocMind-Pdf" style="color: #00e5a0; text-decoration: none;">DocMind-PDF</a></h4>
  ...
  <tr>
    <td width="50%" valign="top">
      <h4><a href="https://kankariya.vercel.app" style="color: #00e5a0; text-decoration: none;">Kankariya</a></h4>
    ...
    <td width="50%" valign="top">
      <h4><a href="https://github.com/aashishbagmar/AI-Stock-Prediction" style="color: #00e5a0; text-decoration: none;">AI Stock Prediction</a></h4>
...
<p align="center">
  <a href="https://github.com/aashishbagmar?tab=repositories" style="text-decoration: none;">
    <span style="background-color: #111926; border: 1px solid rgba(0,229,160,0.2); box-shadow: 0 0 20px rgba(0,229,160,0.15); border-radius: 16px; padding: 10px 22px; color: #00e5a0; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Helvetica, Arial, sans-serif; font-size: 14px; font-weight: 600;">
